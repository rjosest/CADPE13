/*=========================================================================
  ...
  Module:    $RCSfile: itkWholeLungVesselAndAirwaySegmentationImageFilter.txx,v $
  Language:  C++
  Date:      $Date: 2011/05/04 21:20:38 $
...
=========================================================================*/
#ifndef _itkWholeLungVesselAndAirwaySegmentationImageFilter_txx
#define _itkWholeLungVesselAndAirwaySegmentationImageFilter_txx
...
WholeLungVesselAndAirwaySegmentationImageFilter< TInputImage >
...
::SetNonLungAirwayRegion()
{
  ...
  int elementRadius = 3;
  unsigned short wholeLungAirwayValue = this->m_LungConventions.GetValueFromLungRegionAndType( WHOLELUNG, AIRWAY );
  ...
  ExtractLabelMapType::Pointer labelMapExtractor = ExtractLabelMapType::New();
    ...
    labelMapExtractor->SetLungRegion( static_cast< unsigned char >( WHOLELUNG ) );
  ...
  Indent indent) const
{
  ...
  os << indent << "Printing itkWholeLungVesselAndAirwaySegmentationImageFilter: " << std::endl;
}
