/*=========================================================================
  ...
  Module:    $RCSfile: itkAutoThresholdAirwaySegmentationImageFilter.h,v $
  Language:  C++
  Date:      $Date: 2011/10/16 18:43:22 $
...
=========================================================================*/
#ifndef __itkAutoThresholdAirwaySegmentationImageFilter_h
#define __itkAutoThresholdAirwaySegmentationImageFilter_h
...
namespace itk
{
/** \class AutoThresholdAirwaySegmentationImageFilter
...
class ITK_EXPORT AutoThresholdAirwaySegmentationImageFilter :
...
public:
  ...
  typedef AutoThresholdAirwaySegmentationImageFilter             Self;
  ...
  itkTypeMacro(AutoThresholdAirwaySegmentationImageFilter, ImageToImageFilter);
...
protected:
  ...
  AutoThresholdAirwaySegmentationImageFilter();
  virtual ~AutoThresholdAirwaySegmentationImageFilter() {}

  void GenerateData();
  void Test();

private:
  AutoThresholdAirwaySegmentationImageFilter(const Self&); //purposely not implemented
...
#include "itkAutoThresholdAirwaySegmentationImageFilter.txx"
#endif
