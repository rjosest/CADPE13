/*=========================================================================
  ...
  Module:    $RCSfile: itkWholeLungVesselAndAirwaySegmentationImageFilter.h,v $
  Language:  C++
  Date:      $Date: 2011/05/03 22:17:20 $
...
=========================================================================*/
#ifndef __itkWholeLungVesselAndAirwaySegmentationImageFilter_h
#define __itkWholeLungVesselAndAirwaySegmentationImageFilter_h
...
#include "itkAutoThresholdAirwaySegmentationImageFilter.h"
...
class ITK_EXPORT WholeLungVesselAndAirwaySegmentationImageFilter :
...
public:
  ...
  typedef WholeLungVesselAndAirwaySegmentationImageFilter        Self;
  ...
  itkTypeMacro(WholeLungVesselAndAirwaySegmentationImageFilter, ImageToImageFilter);
...
protected:
  ...
  WholeLungVesselAndAirwaySegmentationImageFilter();
  virtual ~WholeLungVesselAndAirwaySegmentationImageFilter() {}
...
private:
  WholeLungVesselAndAirwaySegmentationImageFilter(const Self&); //purposely not implemented
...
#include "itkWholeLungVesselAndAirwaySegmentationImageFilter.txx"
#endif
